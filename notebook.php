<?php
// notebook.php by John Phillips on 4/18/2017
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>John's Poetry Notebook</title>
        <link rel="stylesheet" href="mystyle.css">
    </head>
    <body>
        <header>
            <h1>John's Poetry Notebook</h1>
        </header>
...
// display a form for adding new poems
        ...
        <footer>
            Poetry Notebook by John Phillips is licensed under a 
